      ...
      <div class="card-body login-card-body">
        ...
        <form action="<?php echo base_url(); ?>index.php/main/do_login" method="post">
          ...
          <div class="row">
            <!-- /.col -->
            <div class="col-4">
              <button type="submit" name="submit" class="btn btn-primary btn-block" value="submit">Sign In</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
        ...
        <p class="mb-0">
          <a href="<?php echo base_url(); ?>index.php/main/register" class="text-center regist">Register</a>
        </p>
      </div>
      <!-- /.login-card-body -->
    </div>
